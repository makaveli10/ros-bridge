...
def get_data(
    ...
    info = {
        "points": lidar_path,
        "cams": dict(),
        "lidar2ego_translation": lidar2ego_translation[0],
        "lidar2ego_rotation": lidar2ego_rotation[0],
        "ego2global_translation": ego2global_translation[0],
        "ego2global_rotation": ego2global_rotation[0],
    }
    ...
    #     lidar_path, l2e_t, l2e_r_mat, e2g_t, e2g_r_mat, e2g_r, "lidar", lidar_rotation=l2e_r
    # )
    info["sweeps"] = []
    xx
    return info
...
def obtain_sensor2top_test(data, l2e_t, l2e_r_mat, e2g_t, e2g_r_mat, e2g_r, sensor_type="lidar", cam_translations=None, cam_rotations=None, lidar_rotation=None):
    ...
    """
    print(l2e_t, l2e_r_mat, e2g_t, e2g_r_mat, e2g_r)
    # xx
